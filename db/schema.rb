...
ActiveRecord::Schema.define(version: 2021_03_10_100712) do
  ...
  create_table "purchase_managements", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["product_listing_id"], name: "index_purchase_managements_on_product_listing_id"
  ...
  add_foreign_key "purchase_managements", "product_listings"
